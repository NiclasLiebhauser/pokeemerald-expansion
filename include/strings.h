...
extern const u8 gText_AncientPlate[];
extern const u8 gText_RedOrb[];
extern const u8 gText_BlueOrb[];
extern const u8 gText_CantUseTentIndoor[];
extern const u8 gText_UsedTent[];

...
#define FLAG_ITEM_MYSTERY_CAVE_SOFT_SAND                            0x493
...
#define FLAG_HIDE_PALKIA                                            0x4A6
#define FLAG_HIDE_DIALGA                                            0x4A7
#define FLAG_HIDE_SPENSER                                           0x4A8
#define FLAG_HIDE_GIOVANNI_CUSCENE                                  0x4A9
...
#define FLAG_VISITED_AQUA_HIDEOUT                   (SYSTEM_FLAGS + 0x21)
#define FLAG_VISITED_SACRED_CITY                    (SYSTEM_FLAGS + 0x22)

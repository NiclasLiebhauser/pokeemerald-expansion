...
const u8 gText_AncientPlate[] = _("A number barely visible can be read\nwhen inspecting the plate... {COLOR RED}{STR_VAR_1}{COLOR DARK_GRAY}\lWhat could it possibly mean?{PAUSE_UNTIL_PRESS}");
const u8 gText_RedOrb[] = _("You take the {COLOR RED}RED ORB{COLOR DARK_GRAY} out of your bag.{PAUSE_UNTIL_PRESS}");
const u8 gText_BlueOrb[] = _("You take the {COLOR BLUE}BLUE ORB{COLOR DARK_GRAY} out of your bag.{PAUSE_UNTIL_PRESS}");
const u8 gText_CantUseTentIndoor[] = _("You can only camp outdoors.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedTent[] = _("You and your {PKMN} fell well rested.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Excited[] = _("Excited");

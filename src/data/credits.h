...
static const u8 sCreditsText_RHHideout_Channel[]              = _("Team Aqua's Hideout Youtube Channel");
...
static const u8 sCreditsText_PkmnAquaVersion[]                = _("POKéMON H20 VERSION");

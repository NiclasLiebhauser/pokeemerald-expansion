static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_AQUA_HIDEOUT - 1] = {MAP_GROUP(AQUA_HIDEOUT), MAP_NUM(AQUA_HIDEOUT), 20, 15},
    [HEAL_LOCATION_SACRED_CITY - 1] = {MAP_GROUP(SACRED_CITY), MAP_NUM(SACRED_CITY), 48, 14},
    [HEAL_LOCATION_MYSTERY_CAVE - 1] = {MAP_GROUP(ROUTE201), MAP_NUM(ROUTE201), 15, 14},
};

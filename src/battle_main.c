...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TEAM_AQUA, "TEAM AQUA", 7),
    ...
    TRAINER_CLASS(SWIMMER_M, "SWIMMER♂", 12, ITEM_DIVE_BALL),
    TRAINER_CLASS(TEAM_MAGMA, "TEAM MAGMA", 7),
    TRAINER_CLASS(EXPERT, "EXPERT", 10),
    TRAINER_CLASS(AQUA_ADMIN, "AQUA ADMIN", 15),
    TRAINER_CLASS(BLACK_BELT, "BLACK BELT", 8, ITEM_ULTRA_BALL),
    TRAINER_CLASS(AQUA_LEADER, "AQUA LEADER", 25, ITEM_MASTER_BALL),
    ...
    TRAINER_CLASS(TUBER_F, "TUBER", 9),
    TRAINER_CLASS(TUBER_M, "TUBER", 9),
    ...
    TRAINER_CLASS(TEAM_ROCKET, "TEAM ROCKET", 15),
    TRAINER_CLASS(ROCKET_LEADER, "RCKT. LEADER", 50),
    TRAINER_CLASS(ARCEUS, "{PKMN} GOD"),
};

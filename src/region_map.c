...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_MAGMA_HIDEOUT,              MAPSEC_MAGMA_ISLAND},
    ...
    {MAPSEC_UNDERWATER_205,             MAPSEC_ROUTE_205},
    {MAPSEC_UNDERWATER_206,             MAPSEC_ROUTE_206},
    {MAPSEC_SACRED_MOUNTAIN,            MAPSEC_SACRED_CITY},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_AQUA_HIDEOUT] = {MAP_GROUP(AQUA_HIDEOUT), MAP_NUM(AQUA_HIDEOUT), HEAL_LOCATION_AQUA_HIDEOUT},
    [MAPSEC_SACRED_CITY] = {MAP_GROUP(SACRED_CITY), MAP_NUM(SACRED_CITY), HEAL_LOCATION_SACRED_CITY},
    [MAPSEC_ROUTE_201] = {MAP_GROUP(ROUTE201), MAP_NUM(ROUTE201), HEAL_LOCATION_MYSTERY_CAVE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_AQUA_HIDEOUT:
        return FlagGet(FLAG_VISITED_AQUA_HIDEOUT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SACRED_CITY:
        return FlagGet(FLAG_VISITED_SACRED_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
